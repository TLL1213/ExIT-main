...
def parse_args():
    ...
    # 验证集
    parser.add_argument('--data_path', type=str, default='../data/nacgec/nacgec.test.input', help='Test Data Path')
    parser.add_argument('--output_path', type=str, default='../data/nacgec/NACGEC_sampling_10_qwen2_7B.jsonl', help='uuid for sentences containing grammatical errors')
